...
export default function BudgetItem({ budget }: { budget: BudgetType }) {
  ...
  // Handle the navigation via code instead of a <Link> wrapper
  ...
  return (
    <div
      ...
      className="cursor-pointer rounded-2xl border border-slate-800 bg-slate-900/70 p-4 shadow-sm transition hover:-translate-y-1 hover:shadow-md hover:bg-slate-800/50 sm:rounded-3xl sm:p-5"
    >
      <div className="flex flex-col gap-4">
        <div className="flex items-start justify-between gap-3">
          ...
          {/* This extra onClick wrapper ensures clicks on the buttons NEVER trigger the card's navigation */}
          <div
